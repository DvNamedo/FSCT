    ...
    public class ThirdPersonController : MonoBehaviour
    {
        ...
        */
        private void MoveRelativeToGameObject(Transform gameObjectA)
        {
            ...
            // Calculate input direction relative to world space
            Vector3 forwardDirection = gameObjectA.forward; // Assuming forward direction of gameObjectA is relevant
            Vector3 rightDirection = gameObjectA.right; // Assuming right direction of gameObjectA is relevant
