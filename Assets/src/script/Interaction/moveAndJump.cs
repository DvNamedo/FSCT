...
namespace StarterAssets
{
    ...
    public class moveAndJump : MonoBehaviour
    {
        ...
        private void Move()
        {
            ...
            // rotate input direction to match the camera target's direction
            Vector3 targetDirection = CinemachineCameraTarget.transform.TransformDirection(inputDirection);
            targetDirection.y = 0.0f;  // ignore vertical component
